...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Ближайший к площади 3" + targetArea + " треугольник: " + closeAreaTriangle);
            ...
            System.out.println("Треугольники, помещающиеся в окружность радиуса 2.5 " + radius + ": " + trianglesInCircle);

            float targetSumArea = 5.0f;
            List<Triangle> closeSumAreaTriangles = db.getTrianglesCloseToSumArea(targetSumArea);
            System.out.println("Треугольники, сумма площадей которых наиболее приближена к 5 " + targetSumArea + ": " + closeSumAreaTriangles);
            ...
            System.out.println("Все тупоугольные треугольники с площадью больше 2" + minArea + ": " + obtuseTriangles);
